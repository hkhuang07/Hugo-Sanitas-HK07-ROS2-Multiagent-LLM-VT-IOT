...
from simulation.hugo_telemetry_sim import HugoTelemetrySim
...
def main(args=None):
    ...
    log.info("=== INITIALIZING ROS2 PROCESS UNIFICATION: MultiThreadedExecutor ===")

    balance_node = None
    hugo_telemetry_node = None
    physics_node = None
    nav_node = None
    rppg_node = None
    watchdog_node = None
    ...
    try:
        ...
        hugo_telemetry_node = HugoTelemetrySim()
        ...
        executor.add_node(hugo_telemetry_node)
        ...
        nodes_to_cleanup = [
            balance_node, hugo_telemetry_node, physics_node,
